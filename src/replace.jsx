...
// import Context from '../../LeftPanel/Context/Context';
...
//           addContextTestStatements(), //chloe context
...
//   const addContextTestStatements = () => {
//      testCase.statements.forEach(statement => {
//        switch (statement.type) {
//          case 'context': 
...
//       testFileCode += `Test ('${testCase.testStatement}', () => {
//         const { getByText } = render(${context.consumerComponent})
//         expect(${context.querySelector}(/^${context.textNode} :/)).${context.queryVariant}('${context.TextNode} Unknown')
//       })`
//     } else if (context.queryValue === 'shows_value_from_provider'){
//       testFileCode += `Test ('${testCase.testStatement}', () => {
//         const tree = (
//           <${context.context}.provider value='${context.values}'>
//             <${context.consumerComponent}/>
//           </${context.context}.provider>
//         )
//         const { getByText } = render(tree)
//         expect(${context.querySelector}(/^${context.textNode}:/)).${context.queryVariant}('${context.textNode} ${context.values}')
//       })`
//     } else if (context.queryValue === 'component_provides_context_value'){
//       testFileCode += `Test ('${testCase.testStatement}', () => {
//         const tree = (
//           <${context.providerComponent} ${context.textNode} : '${context.values}'>
//             <${context.context}.Consumer>
//             {value => <span>Recieved: {value} </span>}
//             <${context.context}.Consumer
//           </${context.providerComponent}>
//         )
//         const { ${context.querySelector} } = render(tree)
//         expect(${context.querySelector}(/^${context.textNode}:/).textContent).${context.queryVariant}('${context.textNode} ${context.values}')
//       })`
//     } else if (context.queryValue === 'renders_providers_+_consumers_normally'){
//       testFileCode += `Test ('${testCase.testStatement}', () => {
//         const tree = (
//           <${context.providerComponent} ${context.textNode} : '${context.values}'>
//             <${context.consumerComponent}/>
